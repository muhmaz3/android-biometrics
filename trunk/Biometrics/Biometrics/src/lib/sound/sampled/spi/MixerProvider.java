...
package lib.sound.sampled.spi;

import lib.sound.sampled.Mixer;
...
public abstract class MixerProvider {
     ...
     * @see #getMixer(lib.sound.sampled.Mixer.Info) getMixer(Mixer.Info)
     * @see #isMixerSupported(lib.sound.sampled.Mixer.Info) isMixerSupported(Mixer.Info)
     */
