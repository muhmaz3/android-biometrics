package thesis.biometrics.face;
...
import thesis.biometrics.R;
import thesis.biometrics.ScreenFaceRecognizing;
...
public class FaceRecognizer {
	...
	public void recognizeObjectByFace(String imagePath) {
	...
	private class RecognizingTask extends AsyncTask<String, Void, Boolean> {
		...
		protected void onPostExecute(Boolean result) {
			...
			tv.setText("YOUR CONFIDENCE: "+df.format(resultConfidence));

			//TODO Delete some garbage images after testing
		}
...
//			int nearest = trainPersonNumMat.data_i().get(iNearest);
			...
			return confidence >= ScreenFaceRecognizing.threshold;
		}
		...
		private CvMat loadTrainingData() {
			...
			fileStorage = cvOpenFileStorage(
					AppConst.FACE_FOLDER+ "/facedata.xml", 
