 ...
 */
package thesis.biometrics.util;
...
public class IconContextMenu implements DialogInterface.OnCancelListener, 
	...
	public void addItem(Resources res, CharSequence title, int actionTag) {
		menuAdapter.addItem(new IconContextMenuItem(res, title, actionTag));
	}
	
	public void addItem(Resources res, int textResourceId,
			int imageResourceId, int actionTag) {
		menuAdapter.addItem(new IconContextMenuItem(res, textResourceId, actionTag));
	}
...
//	        	temp.setCompoundDrawablePadding((int)toPixel(res, 14));
    ...
    protected class IconContextMenuItem {
		 ...
		 */
		public IconContextMenuItem(Resources res, int textResourceId, int actionTag) {
		 ...
		 * 			indicate action of menu item
		 */
		public IconContextMenuItem(Resources res, CharSequence title, int actionTag){
			text = title;			
			this.actionTag = actionTag;
		}
	}
