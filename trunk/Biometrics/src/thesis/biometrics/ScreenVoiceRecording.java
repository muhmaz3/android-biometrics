...
import thesis.biometrics.voice.ExtAudioRecorder;
		...
		public void onClick(View v) {
			...
			case R.id.play:
				...
				//Set time when start record
                 ...
                 isRunThread = true;
                 myThread.start();
				audioRedorder = ExtAudioRecorder.getInstanse(false); // Uncompressed recording (WAV)		         
			...
			case R.id.save:
				if(!isRunThread){
					Toast.makeText(ScreenVoiceRecording.this, "Please record voice before 'Save'", Toast.LENGTH_SHORT).show();
				}else{
					txtStatus.setText("Preparing to record");
