...
package thesis.lib.com.sun.media.codec.audio.mp3;

import java.lang.reflect.Method;

import thesis.lib.sound.sampled.AudioFormat;
import thesis.lib.sound.sampled.AudioInputStream;
import thesis.lib.sound.sampled.spi.FormatConversionProvider;
...
{
    private static class AFE extends thesis.lib.sound.sampled.AudioFormat.Encoding
    {
    ...
    public thesis.lib.sound.sampled.AudioFormat.Encoding[] getSourceEncodings()
    {
        return sourceEncodings;
    }

    public thesis.lib.sound.sampled.AudioFormat.Encoding[] getTargetEncodings()
    {
        return targetEncodings;
    }

    public thesis.lib.sound.sampled.AudioFormat.Encoding[] getTargetEncodings(AudioFormat sourceFormat)
    {
        if(getTargetFormats(sourceFormat, true) == null)
            return new thesis.lib.sound.sampled.AudioFormat.Encoding[0];
        else
            return getTargetEncodings();
    }

    public AudioFormat[] getTargetFormats(thesis.lib.sound.sampled.AudioFormat.Encoding targetEncoding, AudioFormat sourceFormat)
    {
    ...
    public AudioInputStream getAudioInputStream(thesis.lib.sound.sampled.AudioFormat.Encoding targetEncoding, AudioInputStream sourceStream)
    {
    ...
    private static boolean encodingEquals(thesis.lib.sound.sampled.AudioFormat.Encoding enc1, thesis.lib.sound.sampled.AudioFormat.Encoding enc2)
    {
    ...
    private static thesis.lib.sound.sampled.AudioFormat.Encoding getEncoding(String name)
    {
        thesis.lib.sound.sampled.AudioFormat.Encoding ret = null;
        if(!triedTritonus || tGetEncoding != null)
            try
            {
                ...
                args[0] = name;
                ret = (thesis.lib.sound.sampled.AudioFormat.Encoding)tGetEncoding.invoke(null, args);
                if(DEBUG && firstTime)
    ...
    static final thesis.lib.sound.sampled.AudioFormat.Encoding MPEG1L1;
    static final thesis.lib.sound.sampled.AudioFormat.Encoding MPEG1L2;
    static final thesis.lib.sound.sampled.AudioFormat.Encoding MPEG1L3;
    static final thesis.lib.sound.sampled.AudioFormat.Encoding MPEG2L1;
    static final thesis.lib.sound.sampled.AudioFormat.Encoding MPEG2L2;
    static final thesis.lib.sound.sampled.AudioFormat.Encoding MPEG2L3;
    static final thesis.lib.sound.sampled.AudioFormat.Encoding MP3;
    static final thesis.lib.sound.sampled.AudioFormat.Encoding SIGNED;
    private static final thesis.lib.sound.sampled.AudioFormat.Encoding sourceEncodings[];
    private static final thesis.lib.sound.sampled.AudioFormat.Encoding targetEncodings[];
    ...
    static 
    {
        ...
        MP3 = getEncoding("MP3");
        SIGNED = thesis.lib.sound.sampled.AudioFormat.Encoding.PCM_SIGNED;
        sourceEncodings = (new thesis.lib.sound.sampled.AudioFormat.Encoding[] {
            MPEG1L1, MPEG1L2, MPEG1L3, MP3, MPEG2L1, MPEG2L2, MPEG2L3
        });
        targetEncodings = (new thesis.lib.sound.sampled.AudioFormat.Encoding[] {
            SIGNED
        });
        targetFormats = null;
        if(DEBUG)
