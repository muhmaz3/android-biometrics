...
package thesis.lib.sound.sampled.spi;

import thesis.lib.sound.sampled.Mixer;
...
public abstract class MixerProvider {
     ...
     * @see #getMixer(thesis.lib.sound.sampled.Mixer.Info) getMixer(Mixer.Info)
     * @see #isMixerSupported(thesis.lib.sound.sampled.Mixer.Info) isMixerSupported(Mixer.Info)
     */
