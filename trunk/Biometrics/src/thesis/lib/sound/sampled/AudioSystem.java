...
package thesis.lib.sound.sampled;
...
import thesis.lib.sound.sampled.spi.AudioFileWriter;
import thesis.lib.sound.sampled.spi.FormatConversionProvider;
import thesis.lib.sound.sampled.spi.MixerProvider;
 ...
 * name of a concrete {@link thesis.lib.sound.sampled.spi.MixerProvider
...
//        System.out.println(codecs.get(0).getClass().getName());
        for(int i = 0; i <= codecs.size(); i++) {
//            FormatConversionProvider codec = (FormatConversionProvider) codecs.get(i);
            FormatConversionProvider codec = (FormatConversionProvider) new thesis.lib.com.sun.media.codec.audio.mp3.JS_MP3ConversionProvider();
...
//        System.out.println(providers.size());
        for(int i = 0; i <= providers.size(); i++ ) {
//            AudioFileReader reader = (AudioFileReader) (new thesis.lib.com.sun.media.codec.audio.mp3.JS_MP3FileReader());
        	AudioFileReader reader = (AudioFileReader) (new thesis.lib.com.sun.media.sound.WaveFileReader());
            try {
     ...
     * @return an array of
     * {@link thesis.lib.sound.sampled.spi.FormatConversionProvider
     ...
     * @return a List of
     * {@link thesis.lib.sound.sampled.spi.AudioFileReader
     * AudioFileReader}
