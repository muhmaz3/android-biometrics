...
import thesis.lib.lang.AutoCloseable;
 ...
 * done by calling {@link thesis.lib.sound.midi.MidiSystem#getReceiver
 * MidiSystem.getReceiver} and {@link
 * thesis.lib.sound.midi.MidiSystem#getTransmitter
 ...
 * unless the properties <code>july.sound.midi.Receiver</code>
 * and <code>july.sound.midi.Transmitter</code> are used (see the
 * description of properties to select default providers in
 * {@link thesis.lib.sound.midi.MidiSystem}). A <code>MidiDevice</code>
